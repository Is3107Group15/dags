...
DATA_SOURCE_FILE = 'data/number-of-pharmacists/number-of-pharmacists.csv'
...
def extract_data(source_file: str) -> str:
    ...
    local_source_file = '/tmp/num_pharmacists.csv'
...
with DAG(
    ...
    dag.doc_md = "extract number of pharmacists data from gcs and load to data big query (datawarehouse)"
    ...
    remote_filtered_data = f'data/number-of-pharmacists/filtered/{filter_data_task}'
    upload_data_task = upload_file_to_gcs(local_file=filter_data_task, remote_file_path='data/number-of-pharmacists/filtered')
    ...
    load_data = GCSToBigQueryOperator(
        ...
        field_delimiter=',',
        destination_project_dataset_table='project.num_pharmacists',
        skip_leading_rows=1,
        schema_fields=[
